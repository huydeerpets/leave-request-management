...
import { Layout, Form, Icon, Input, Button, Menu, Breadcrumb } from 'antd';
		...
		return (
			<div>
				<Layout>
					...
					<Content className="container" style={{ display: 'flex', margin: '24px 16px 0', justifyContent: 'space-around', paddingBottom: '175px' }}>
