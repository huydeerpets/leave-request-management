...
import { Layout, Form, Icon, Input, Button, Menu, Breadcrumb, DatePicker } from 'antd';
					...
					<div style={{ padding: 150, background: '#fff', minHeight: 360 }}>
						...
						<div>
							...
							<Form onSubmit={this.handleSubmit} className="login-form">
								...
								<FormItem>
									<RangePicker
										...
										showTime={{
											...
											defaultValue: [moment(this.props.leaveForm.from), moment(this.props.leaveForm.to)],
										}}
										format="YYYY-MM-DD HH:mm:ss"
										selected={this.props.leaveForm.from
								...
								<FormItem>
									<Button onClick={this.handleSubmit} htmlType="submit" type="primary">Register</Button>
								</FormItem>
							</Form>
						</div>
